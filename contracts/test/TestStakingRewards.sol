...
import "./TestRewardsDistributionRecipient.sol";

import "../uniswap/UniswapV2LiquidityMathLibrary.sol";
import "../uniswap/UniswapV2Library.sol";

contract TestStakingRewards is IStakingRewards, TestRewardsDistributionRecipient, ReentrancyGuard {
    ...
    function getUserScore(address account) public override view returns (uint256) {
        return 1000;
